...
This is a React Native FinTech clone using [Clerk](https://clerk.com/?utm_source=sponsorship&utm_medium=github&utm_campaign=simong&utm_content=rn-fintech) for user authentication with OTP. This app was inspired by the [Revolut](https://www.revolut.com/) app.
...
<div style="display: flex; flex-direction: 'row';">
<img src="./screenshots/login.gif" width=40%>
<img src="./screenshots/state.gif" width=40%>
<img src="./screenshots/lockscreen.gif" width=40%>
<img src="./screenshots/charts.gif" width=40%>
<img src="./screenshots/icon.gif" width=40%>
